    ...
    choices: [
        ...
        switch (val.choice) {
          ...
          case "Want to view by role?":
            ...
            case "Want to add a team member?":
              addEmployee();
            break;
    ...
    inquirer.prompt([
          {
            ...
            message: "State the empployee last name? ",
          },
          {
            name: "role",
            type: "rawlist",
        ...
        var roleId = selectRole().indexOf(val.role) + 1
        connection.query("update set to where", 
        {
          last_name: val.lastName
